...
const CommentComposer: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 pointer-events-auto px-3 pb-6 pt-3" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
